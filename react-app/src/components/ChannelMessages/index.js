...
function ChannelMessages() {
    ...
    useEffect(()=> {
        console.log('here', messageContainer.current.scrollHeight)
        ...
        <div className='channel-messages-container'>
            <div ref={messageContainer} className='channel-message-container'>
                <div className='channel-title-container'>
                    <svg classname='channel-title-hashtag' width="20" height="20" viewBox="0 0 24 24">
                    ...
                    <h3 tabindex='-1' className='channel-title'>{channel.name}</h3>
                </div>
                <div className='fixed'>
                </div>
